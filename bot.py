...
def train(dataset_dir, epochs=100):
    ...
    # Get dataset and splitting it for training and validation
...
def predict(image_dir):
    """
    Args:
        image_dir: The filepath of the screenshot image

    Return:
        prediction: The prediction country
        coordinates: The centroid coordinates of the country
        confidence: The confidence percentage for the prediction
    """
